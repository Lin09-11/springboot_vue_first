...
官网：[入门和安装 - 《Hutool v4.5.15 参考文档》 - 书栈网 · BookStack](https://www.bookstack.cn/read/hutool/a6819f05207359bb.md)
...
![image-20230731142701374](D:\SpringBoot+Vue\assets\image-20230731142701374.png)
...
导入的excel和导出的excel中的字段名字要一致，要不然导出的数据为null

![image-20230731143900109](D:\SpringBoot+Vue\assets\image-20230731143900109.png)
...
![image-20230731145408371](D:\SpringBoot+Vue\assets\image-20230731145408371.png)
...
![image-20230731145454894](D:\SpringBoot+Vue\assets\image-20230731145454894.png)

![image-20230731145724283](D:\SpringBoot+Vue\assets\image-20230731145724283.png)
...
![image-20230731150012550](D:\SpringBoot+Vue\assets\image-20230731150012550.png)

```vue
<!--      on-success:调用成功时的一个钩子-->
...
# 十一、SpringBoot和Vue的用户登录

### 1.基本页面

![image-20230731151216399](D:\SpringBoot+Vue\assets\image-20230731151216399.png)
...
![image-20230731163245075](D:\SpringBoot+Vue\assets\image-20230731163245075.png)

#### 2.2 前端验证不通过，不发送请求【使用ref】

![image-20230731164831413](D:\SpringBoot+Vue\assets\image-20230731164831413.png)
...
`当数据库中有相同的用户名和密码，在进行登录时后台会报错`

![image-20230731165237078](D:\SpringBoot+Vue\assets\image-20230731165237078.png)

![image-20230731165211134](D:\SpringBoot+Vue\assets\image-20230731165211134.png)
